...
image:https://img.shields.io/maven-central/v/io.github.dmlloyd/ffm-autolinker?color=green[link=https://search.maven.org/search?q=g:io.github.dmlloyd%20AND%20a:ffm-autolinker]
